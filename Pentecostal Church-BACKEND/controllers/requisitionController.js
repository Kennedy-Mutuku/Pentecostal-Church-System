...
const requisitionController = {
  ...
  generatePDF: async (req, res) => {
    try {
      ...
      // Institution Header
      doc.fontSize(16).font('Helvetica-Bold').text('Rikuruma Pentecostal Church', { align: 'center' });
      ...
      doc.text(`Generated: ${new Date().toLocaleString()} | RPC Missions & Community`, { align: 'center' });
