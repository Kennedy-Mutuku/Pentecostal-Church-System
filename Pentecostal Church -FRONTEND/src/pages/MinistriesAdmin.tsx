...
const MinistriesAdmin: React.FC = () => {
    ...
    const handleAuth = async () => {
        if (password === 'rpc-ministries-admin-2024') {
    ...
    const generateAttendancePDFContent = (formData: GeneratedForm) => {
        return `
            ...
            <html>
            <head>
                <title>RPC Nyamira - ${formData.title}</title>
                <style>
    ...
    const generateCommitmentPDFContent = (formData: GeneratedForm) => {
        return `
            ...
            <body>
                <img src="/img/letterhead.png" class="letterhead-img" alt="RPC Nyamira Letterhead" />
                
                <div class="header">
                    <h1>Rikuruma Pentecostal Church - Nyamira</h1>
                    <h2>${formData.title}</h2>
                </div>
                ...
                <div class="footer">
                    <hr />
                    <p><strong>RPC Nyamira | P.O BOX 408-40200, KISII, KENYA</strong></p>
                    <p>www.rpcmc.org | rpcnyamira@gmail.com</p>
    ...
    const downloadCommitmentPDF = (commitment: CommitmentForm) => {
        const htmlContent = `
            ...
            <html>
            <head>
                <title>RPC - ${selectedMinistry ? ministryNames[selectedMinistry] : ''} - Commitment Form</title>
                <style>
                    @page { size: A4; margin: 15mm; }
            ...
            <body>
                ...
                <div style="margin-top: 50px; text-align: center; font-size: 12px; color: #666;">
                    ...
                    <p style="margin: 5px 0;">RPC Nyamira | P.O BOX 408-40200, KISII, KENYA</p>
                    <p style="margin: 5px 0;">www.rpcmc.org | rpcnyamira@gmail.com</p>
                                        ...
                                        <div key={commitment._id} className={styles.commitmentCard}>
                                            ...
                                            <div className={styles.commitmentActions}>
                                                ...
                                                <button
                                                    ...
                                                    title="Generate forms report with RPC header"
                                                >
                                        ...
                                        {attendanceRecords.length > 0 && (
                                            <div className={styles.generateFormSection}>
                                                <button
                                                    ...
                                                    title="Generate attendance form with RPC header"
                                                >
                    ...
                    <div className={styles.contentArea}>
                        <div className={styles.sectionHeader}>
                            ...
                            <p className={styles.sectionDescription}>
                                View, download, and manage all generated forms with RPC headers
                            </p>
                        </div>
