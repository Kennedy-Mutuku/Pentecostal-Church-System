...
function EditorialBoard() {
  ...
  const cardData = [
    ...
    },
    {
      ...
      desc: "Publishes the church weekly magazine to enrich members.",
      active: true,
    },
    {
    ...
    },
    {
      ...
      icon: "fas fa-pen-nib",
      desc: "Drafts empowering and spiritual articles for the church.",
      active: false,
    },
  ];
    ...
    <div className="sdb-wrapper">
      ...
      <section className="sdb-hero">
        ...
        <div className="sdb-hero-content">
          <div className="sdb-hero-eyebrow">Writing &amp; Editing</div>
          ...
          <p className="sdb-hero-subtitle">
            Connecting and Building the Literary Ecosystem for RPC Nyamira
          </p>
        </div>
      </section>
      ...
      <section>
        <div className="sdb-section-header">
          <h2>What We Do</h2>
          <p>
            Our board covers every facet of the church's publications and notice board curation.
          </p>
      ...
      <section style={{ padding: "0 20px 20px" }}>
        <div className="sdb-recruitment">
          <div className="sdb-recruitment__inner">
            ...
            <p>
              Are you passionate about writing, editing, curating magazines, or managing information boards? Join the RPC Nyamira Editorial Board and put your skills to Kingdom use.
            </p>
            ...
            {showJoin && (
              <div className="sdb-join-panel">
                <h3>How to Join</h3>
                <ol>
                  <li>Write a formal application letter to the Editorial Board Overseer, stating your writing/editing background and area of interest.</li>
      ...
      <div className="sdb-footer-strip">
        RPC Nyamira Editorial Board — Transforming Lives, Impacting Nations through the Written Word.
      </div>
    </div>
  );
}
