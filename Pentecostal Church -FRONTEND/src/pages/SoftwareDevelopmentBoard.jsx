...
const roleCards = [
  { icon: "fas fa-code",                title: "Software Development", desc: "Build and maintain all RPC Nyamira internal web and mobile platforms.", featured: false },
  { icon: "fas fa-tools",               title: "System Maintenance",   desc: "Keep every church system running smoothly 24 / 7.",             featured: true  },
  { icon: "fas fa-shield-alt",          title: "Cybersecurity",        desc: "Protect member data and church assets from digital threats.",    featured: false },
  { icon: "fas fa-database",            title: "Database Management",  desc: "Design, optimise, and secure the church's central databases.",  featured: false },
  { icon: "fas fa-lightbulb",           title: "Innovation & Research", desc: "Explore emerging tech to continuously grow the church.",       featured: false },
];
    ...
    <div className="sdb-wrapper">
      ...
      <section className="sdb-hero">
        ...
        <div className="sdb-hero-content">
          ...
          <p className="sdb-hero-subtitle">
            Building and sustaining the digital backbone of RPC Nyamira — one commit
      ...
      <section>
        <div className="sdb-section-header">
          <h2>What We Do</h2>
          <p>
            Our board covers every facet of the church's technology stack — from
      ...
      <section style={{ padding: "0 20px 20px" }}>
        <div className="sdb-recruitment">
          <div className="sdb-recruitment__inner">
            ...
            <p>
              Passionate about software, design, or systems? Join the RPC Nyamira
      ...
      <div className="sdb-footer-strip">
        RPC Nyamira Software Development &amp; Maintenance Board — Transforming
        Lives, Impacting Nations through Technology.
      </div>
    </div>
  );
}
