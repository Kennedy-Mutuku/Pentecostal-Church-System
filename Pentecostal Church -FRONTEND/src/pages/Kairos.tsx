        ...
        <div className="bg-[#ffffff] min-h-screen text-[#000000] font-sans">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                ...
                <div className="text-center mb-12 pt-8">
                    <h1 className="text-4xl md:text-5xl font-bold text-[#3b1a62] mb-6">
                ...
                <div className="grid grid-cols-1 gap-12 mb-16 items-start">
                    ...
                    <div className="space-y-8 max-w-3xl mx-auto">
                        <div className="bg-white p-6 border-l-4 border-[#3b1a62] shadow-sm">
                            <h2 className="text-2xl font-bold text-[#3b1a62] mb-4">
                                What is Kairos?
                            </h2>
                        ...
                        <div className="bg-[#3b1a62]/5 p-6 rounded-lg border border-[#3b1a62]/10">
                            <h4 className="text-[#3b1a62] font-bold text-lg mb-2">Key Focus</h4>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
                    <div className="bg-[#ffffff] p-8 rounded-xl border border-[#3b1a62]/20 shadow-sm hover:shadow-md transition-shadow hover:-translate-y-1 duration-300">
                        <h3 className="text-xl font-bold text-[#3b1a62] mb-4">Biblical Foundation</h3>
                        <p className="text-[#000000]">
                            Discover God's heart for all peoples from Genesis to Revelation and see how mission is central to the Bible's narrative.
                        </p>
                    </div>
                    <div className="bg-[#ffffff] p-8 rounded-xl border border-[#3b1a62]/20 shadow-sm hover:shadow-md transition-shadow hover:-translate-y-1 duration-300">
                        <h3 className="text-xl font-bold text-[#3b1a62] mb-4">Historical Perspective</h3>
                        <p className="text-[#000000]">
                            Trace the advance of the Gospel throughout history and learn from the successes and failures of the missions movement.
                        </p>
                    </div>
                    <div className="bg-[#ffffff] p-8 rounded-xl border border-[#3b1a62]/20 shadow-sm hover:shadow-md transition-shadow hover:-translate-y-1 duration-300">
                        <h3 className="text-xl font-bold text-[#3b1a62] mb-4">Strategic & Cultural</h3>
                        <p className="text-[#000000]">
                ...
                {/* Call to Action */}
                <div className="bg-[#3b1a62] text-white rounded-2xl p-10 text-center shadow-lg relative overflow-hidden">
