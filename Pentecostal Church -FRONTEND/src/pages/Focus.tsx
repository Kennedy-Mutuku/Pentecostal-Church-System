    ...
    return (
        <div className="bg-[#ffffff] min-h-screen text-[#000000] font-sans overflow-hidden">
            ...
            <div className="relative">
                {/* Hero Section */}
                <div className="relative h-[60vh] overflow-hidden" style={{ background: 'linear-gradient(135deg, #482078, #3b1a62)' }}>
                    <div className="absolute inset-0 bg-gradient-to-t from-[#3b1a62]/90 via-[#3b1a62]/40 to-transparent flex items-center justify-center">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 -mt-20 relative z-10">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                        {/* Intro Card */}
                        <div className={`bg-white p-8 rounded-2xl shadow-xl border-t-8 border-[#3b1a62] col-span-1 lg:col-span-2 ${fadeInUp('delay-500')}`}>
                            <h2 className="text-3xl font-bold text-[#3b1a62] mb-6 flex items-center gap-3">
                                <Users size={32} />
                        ...
                        <div className={`space-y-4 ${fadeInUp('delay-700')}`}>
                            <div className="bg-[#3b1a62] text-white p-6 rounded-2xl shadow-lg transform hover:-translate-y-2 transition-transform duration-300">
                            ...
                            <div className="bg-white p-6 rounded-2xl shadow-lg border border-[#3b1a62]/10 transform hover:-translate-y-2 transition-transform duration-300">
                                <MapPin className="text-[#3b1a62] mb-4" size={32} />
                    ...
                    <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <div key={index} className={`bg-gray-50 p-8 rounded-2xl border border-gray-100 hover:border-[#3b1a62]/30 hover:shadow-xl transition-all duration-300 group ${fadeInUp(`delay-${index * 200 + 1000}`)}`}>
                                <div className="text-[#3b1a62] mb-6 transform group-hover:scale-110 transition-transform duration-300">
                                    {item.icon}
                                </div>
                    ...
                    <div className={`mt-20 text-center ${fadeInUp('delay-1000')}`}>
                        <div className="inline-block p-1 rounded-full bg-gradient-to-r from-[#3b1a62] to-purple-800">
                            <div className="bg-white rounded-full px-8 py-4 sm:px-12 sm:py-6">
                                <h2 className="text-2xl sm:text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#3b1a62] to-purple-800">
                                    Join the Movement
                                </h2>
                            </div>
                        </div>
