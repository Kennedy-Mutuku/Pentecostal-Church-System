  ...
  const cardData = [
    {
      ...
      desc: "Handles all public relations activities on behalf of the church.",
      active: true,
    },
    {
      title: "Official Comms",
      icon: "fas fa-envelope-open-text",
      desc: "Keeps all forms of official communication belonging to the church.",
      active: false,
    },
    {
      title: "Documentation",
      icon: "fas fa-file-alt",
      desc: "Organizes and structures church communications efficiently.",
      active: false,
    },
    {
      title: "Announcements",
      icon: "fas fa-microphone",
      desc: "Broadcasts and regulates regular church announcements.",
      active: false,
    },
  ];
    ...
    <div className="sdb-wrapper">
      ...
      <section className="sdb-hero">
        ...
        <div className="sdb-hero-content">
          <div className="sdb-hero-eyebrow">Public Relations</div>
          ...
          <p className="sdb-hero-subtitle">
            Connecting and Building the Communication Ecosystem for RPC Nyamira
          </p>
        </div>
      </section>
      ...
      <section>
        <div className="sdb-section-header">
          <h2>What We Do</h2>
          <p>
            Our board covers every facet of the church's communication and public relations.
          </p>
      ...
      <section style={{ padding: "0 20px 20px" }}>
        <div className="sdb-recruitment">
          <div className="sdb-recruitment__inner">
            ...
            <p>
              Passionate about public relations, drafting documents, or managing broadcasts? Join the RPC Nyamira Communication Board and put your skills to Kingdom use.
            </p>
            ...
            {showJoin && (
              <div className="sdb-join-panel">
                <h3>How to Join</h3>
                <ol>
                  <li>Write a formal application letter to the Communication Board Overseer, stating your communication background and area of interest.</li>
      ...
      <div className="sdb-footer-strip">
        RPC Nyamira Communication Board — Transforming Lives, Impacting Nations through Communication.
      </div>
    </div>
  );
}
