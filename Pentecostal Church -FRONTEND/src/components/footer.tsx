          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="lg:col-span-1">
              <div className="flex items-center gap-3 mb-4">
                <img src={cuLogo} alt="RPC Logo" className="w-12 h-12 object-contain" />
                <div>
                  <h3 className="font-bold text-lg">RPC Nyamira</h3>
                  <p className="text-sm text-purple-200">Nyamira</p>
                </div>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                ...
                <li className="flex items-center gap-3">
                  ...
                  <a href="mailto:rpcnyamira@gmail.com" className="text-sm text-purple-200 hover:text-white transition-colors break-all">
