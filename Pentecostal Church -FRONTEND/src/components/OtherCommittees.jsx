...
const OtherCommittees = () => {
  ...
  const committees = [
    ...
    },
    {
      ...
      led: 'RPC Nyamira Treasurer with chair and 7 members with accounting skills (max 9 total).',
    ...
    },
    {
      ...
      led: 'RPC Nyamira Chairperson with chair, secretary, development chair, Elders board, and others (min 9 members).',
      responsibilities: 'Harmonizes church development and RPC Nyamira strategic plans, oversees implementation, advises on Ministry Annual Plans, and coordinates with development committee.'
    },
    {
      slug: 'orientation',
      icon: <FaUserGraduate />,
