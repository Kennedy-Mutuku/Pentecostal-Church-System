...
export type AssistantPatronSection = string;

interface AssistantPatronSidebarProps {
  activeSection: AssistantPatronSection;
  onSectionChange: (section: AssistantPatronSection) => void;
  isOpen: boolean;
  onToggle: () => void;
  onLogout: () => void;
}
...
const AssistantPatronSidebar: React.FC<AssistantPatronSidebarProps> = ({
  activeSection,
  onSectionChange,
  isOpen,
  onToggle,
  ...
  const handleItemClick = (section: AssistantPatronSection) => {
          ...
          <div className={styles.identityBlock}>
            ...
            <div className={styles.identityText}>
              ...
              <span className={styles.roleBadge}>
                <Crown size={10} color="#c9a227" /> ASSISTANT PATRON
              </span>
            </div>
          </div>
...
export default AssistantPatronSidebar;
